	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (!hasDialog)
			...
			case 'senpai' | 'roses' | 'thorns' :		
				portraitLeft = new FlxSprite(-20, 100);
    		...
    		case 'pato gallina' | 'foxy' | 'hombre morado':
				portraitLeft = new FlxSprite(200, 0);
				portraitLeft.frames = Paths.getSparrowAtlas('dialogue/dokiDialogue');
				portraitLeft.animation.addByPrefix('enter', 'Senpai Portrait Enter', 24, false);
				portraitLeft.updateHitbox();
				portraitLeft.scrollFactor.set();
				add(portraitLeft);
			...
			switch(PlayState.SONG.song.toLowerCase()) {
			case 'senpai' | 'roses' | 'thorns':
				portraitRight = new FlxSprite(-20, 100);
			    ...
			    default:
				portraitRight = new FlxSprite(-25, 10);
				portraitRight.frames = Paths.getSparrowAtlas('dialogue/bfNormalPortrait');
				portraitRight.animation.addByPrefix('enter', 'Boyfriend portrait enter', 24, false);
				portraitRight.updateHitbox();
				portraitRight.scrollFactor.set();
				add(portraitRight);
		   ...
		   switch(PlayState.SONG.song.toLowerCase()) {
			case 'pato gallina' | 'foxy' | 'hombre morado':
				...
				portraitMid = new FlxSprite(-25, 10);
